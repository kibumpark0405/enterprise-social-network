<template>
    <v-card outlined>
        ...
        <v-card-text>
            <User offline label="Author" v-model="item.author" :editMode="false" @change="change" />
            <div>
            ...
            <Photo offline label="ImageUrl" v-model="item.imageUrl" :editMode="false" @change="change" />
