            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    <v-list-item
                        class="px-2"
                        key="users"
                        to="/userManagementAndAuthentications/users"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="profiles"
                        to="/profileManagements/profiles"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="posts"
                        to="/postAndNewsFeedManagements/posts"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
            ...
            <v-container v-else class="py-8 px-6 mt-10" fluid>
                <v-row>
                        ...
                        >
                            ...
                            <div style="margin-top:10px;">기업용 SNS SaaS 서비스의 정확하고 편리한 검색 기능을 개발하고 관리합니다.</div>
                        </v-card>
